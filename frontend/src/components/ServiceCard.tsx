...
function ServiceCard({ icon, title, link }: ServiceCardProps) {
  return (
    <div className="min-w-75 h-80 p-10 border border-gray-800 rounded-xl bg-linear-to-b from-gray-900/60 to-black">
      <div className="flex flex-col justify-between h-full w-50">
        {icon}
        <h3 className="text-3xl">{title}</h3>
        <a href={link} className="text-lg text-gray-400">
